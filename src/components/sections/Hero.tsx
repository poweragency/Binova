  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 80% 60% at 50% 100%, rgba(201,179,120,0.10), transparent 60%), radial-gradient(ellipse 60% 40% at 50% 0%, rgba(245,243,239,0.04), transparent 60%)",
        }}
      />
      ...
      <div className="relative mx-auto flex min-h-screen max-w-[1600px] flex-col justify-between px-6 pb-16 pt-36 lg:px-12 lg:pb-20 lg:pt-44">
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="text-[10px] uppercase tracking-[0.4em] text-binova-bone/60">
        ...
        <div className="flex flex-col gap-10">
          <h1 className="font-display font-light leading-[0.95] tracking-tight text-binova-bone">
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
            <p className="max-w-xl text-[clamp(0.95rem,1.1vw,1.05rem)] leading-relaxed text-binova-bone/70">
        ...
        {/* Bottom data row */}
        <div className="mt-16 grid grid-cols-2 gap-8 border-t border-white/5 pt-10 lg:grid-cols-4">
          {[
      ...
      <div className="pointer-events-none absolute right-6 top-1/2 hidden -translate-y-1/2 rotate-90 lg:block">
        <span className="text-[10px] uppercase tracking-[0.5em] text-binova-bone/30">
