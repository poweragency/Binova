...
import { collections, type LocaleKey } from "@/data/collections";
...
export default function Collections() {
  ...
  return (
    <section
      id="collections"
      className="relative scroll-mt-24 bg-binova-black px-6 py-32 max-lg:py-20 max-md:py-16 lg:px-12 lg:py-44"
    >
      <div className="mx-auto max-w-[1600px]">
        ...
        >
          ...
          <p className="max-w-md text-binova-bone/60">{t("intro")}</p>
        </div>
